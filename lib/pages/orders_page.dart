...
import 'package:pks_13/models/order.dart';
import 'package:pks_13/order_bloc/order_bloc.dart';
import 'package:pks_13/order_bloc/order_state.dart';
import 'package:pks_13/widgets/order_card.dart';
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.shopping_cart_outlined, size: 70, color: Colors.purpleAccent),
          SizedBox(height: 20),
          Text(
            "У вас нет заказов",
            style: TextStyle(
          ...
          ElevatedButton.icon(
            onPressed: () {
              // Навигация в каталог или куда-то еще
            },
            icon: Icon(Icons.add_shopping_cart),
            label: Text("Перейти в каталог"),
            style: ElevatedButton.styleFrom(
              backgroundColor: Colors.deepPurpleAccent,  // Исправлено с 'primary' на 'backgroundColor'
